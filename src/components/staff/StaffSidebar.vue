<template>
  <aside :class="['staff-sidebar', { 'is-open': isOpen }]">
    <div class="sidebar-header">
      <router-link to="/staff" class="sidebar-logo">
        <img src="@/assets/img/staff-logo.png" alt="Staff Logo" class="staff-logo-img" v-if="!isMobile" />
        <span class="logo-text" :class="{ 'is-mobile': isMobile }">Staff Panel</span>
      </router-link>
    ...
    <nav class="sidebar-nav">
      <ul>
        <li>
          <router-link to="/staff" exact-active-class="active" @click="closeSidebar">
            <i class="fas fa-tachometer-alt sidebar-icon"></i>
            <span>Dashboard Staff</span>
          </router-link>
        </li>
        <li>
          <router-link to="/staff/order-management" active-class="active" @click="closeSidebar">
        ...
        <li>
          <router-link to="/staff/table-management" active-class="active" @click="closeSidebar">
            <i class="fas fa-chair sidebar-icon"></i>
